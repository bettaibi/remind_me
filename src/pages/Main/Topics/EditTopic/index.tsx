...
import { updateTopic } from '../../../../store/actions/topic.actions';
...
export const EditTopic:React.FC<EditProps> = ({handleToogle, word, findOneAndUpdate}) => {
    ...
    return (
        <React.Fragment>
            <Formik initialValues={INITIAL_VALUE} onSubmit={(values) => update(values)}
                validationSchema={schema}>
                {
                    ({ handleSubmit, handleChange, handleBlur, values, isValid, touched, errors }) => (
                        <Form onSubmit={handleSubmit}>
                            <FullPageHeader handleToggle={handleToogle} title="Edit Topic" />
