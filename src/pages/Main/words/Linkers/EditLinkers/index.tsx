...
import { updateLinker } from '../../../../../store/actions/linkers.actions';
...
export const EditLinkers: React.FC<EditProps> = ({ handleToogle, word, findOneAndUpdate }) => {
    ...
    const INITIAL_VALUE: LinkersModel = {
        ...word
    };
            ...
            <Formik initialValues={INITIAL_VALUE} onSubmit={(value) => update(value)} validationSchema={schema}>
                {
                    ({ handleBlur, handleChange, handleSubmit, errors, touched, values }) => (
                        <Form onSubmit={handleSubmit}>
                            <FullPageHeader handleToggle={handleToogle} title="Edit Linker" />
