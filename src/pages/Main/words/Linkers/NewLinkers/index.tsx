...
import { addLinker } from '../../../../../store/actions/linkers.actions';
import { v4 } from 'uuid';
...
export const NewLinkers: React.FC<AddProps> = ({handleToogle, saveByKey}) => {
            ...
            <Formik initialValues={INITIAL_VALUE} onSubmit={(value, {resetForm}) => create(value, resetForm)} validationSchema={schema}>
                {
                    ({ handleBlur, handleChange, handleSubmit, errors, touched, values }) => (
                        <Form onSubmit={handleSubmit}>
                            <FullPageHeader handleToggle={handleToogle} title="New Linker" />
